$(document).ready(function() {
    ...
    var typed = new Typed('#element', {
      strings: [' Web Analytics Specialist ', 'Social Media Marketing', 'Conversion Rate Optimization', 'Search Engine Marketing'],
      typeSpeed: 50,
      backSpeed: 25,
      loop: true,
...
$(document).ready(function () {
    ...
    animateProgress('.progress-bar-seo', 90, 50); // SEO - 90%
    animateProgress('.progress-bar-smm', 96, 35); // SMM - 85%
    animateProgress('.progress-bar-sem', 92, 60); // SEM - 80%
    animateProgress('.progress-bar-wa', 88, 45); // Web Analytics - 95%
});
